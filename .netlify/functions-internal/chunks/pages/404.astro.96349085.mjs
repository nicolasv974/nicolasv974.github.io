import { c as createAstro, a as createComponent, r as renderTemplate, b as addAttribute, m as maybeRenderHead, s as spreadAttributes, u as unescapeHTML, d as renderComponent, e as renderHead, f as renderSlot } from '../astro.c2cdbe23.mjs';
/* empty css                         *//* empty css                           */
...
const $$MainHead = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const {
    title = "Nicolas Vyplasil: Personal Site",
    description = "Profolio de Nicolas Vyplasil"
  } = Astro2.props;
...
}, "C:/Z_projet/Porfolio_astro/src/components/MainHead.astro");
...
}, "C:/Z_projet/Porfolio_astro/src/components/Icon.astro");
...
` })}`;
}, "C:/Z_projet/Porfolio_astro/src/components/ThemeToggle.astro");
...
const $$Nav = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const textLinks = [
    ...
    //  { label: 'Formation_continue', href: '/formation/' },
    { label: "Mon parcours", href: "/about/" }
  ];
  const iconLinks = [
    { label: "Linkedin", href: "https://www.linkedin.com/in/nicolas-vyplasil-2b11b5167/", icon: "linkedin-logo" },
    // { label: 'Twitch', href: 'https://twitch.tv/me', icon: 'twitch-logo' },
    { label: "GitHub", href: "https://github.com/vypnico974", icon: "github-logo" }
...
}, "C:/Z_projet/Porfolio_astro/src/components/Nav.astro");
  ...
  return renderTemplate`${maybeRenderHead($$result)}<footer class="astro-SZ7XMLTE">
	<div class="group astro-SZ7XMLTE">
		<p class="astro-SZ7XMLTE">
			Profolio développé avec <a href="https://astro.build/" class="astro-SZ7XMLTE">Astro</a>
			${renderComponent($$result, "Icon", $$Icon, { "icon": "rocket-launch", "size": "1.2em", "class": "astro-SZ7XMLTE" })}
		</p>
		<p class="astro-SZ7XMLTE">&copy; ${currentYear} Nicolas Vyplasil</p>
	</div>
	<p class="socials astro-SZ7XMLTE">
		<a href="https://www.linkedin.com/in/nicolas-vyplasil-2b11b5167/" class="astro-SZ7XMLTE"> Linkedin</a>
		<a href="https://github.com/vypnico974" class="astro-SZ7XMLTE"> GitHub</a>
		<!-- <a href="https://codepen.io/me"> CodePen</a> -->
	</p>
</footer>`;
}, "C:/Z_projet/Porfolio_astro/src/components/Footer.astro");
...
}, "C:/Z_projet/Porfolio_astro/src/layouts/BaseLayout.astro");
...
}, "C:/Z_projet/Porfolio_astro/src/components/Hero.astro");
...
` })}`;
}, "C:/Z_projet/Porfolio_astro/src/pages/404.astro");

const $$file = "C:/Z_projet/Porfolio_astro/src/pages/404.astro";
const $$url = "/404";
